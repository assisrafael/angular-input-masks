...
function MonthYearMaskDirective($locale) {
	var dateFormatMapByLocale = {
		'pt-br': 'MM/YYYY',
	};

	var dateFormat = dateFormatMapByLocale[$locale.id] || 'YYYY-MM';

	return {
		restrict: 'A',
		require: 'ngModel',
		link: function(scope, element, attrs, ctrl) {
			var dateMask = new StringMask(dateFormat.replace(/[YM]/g,'0'));
...
MonthYearMaskDirective.$inject = ['$locale'];

module.exports = MonthYearMaskDirective;
